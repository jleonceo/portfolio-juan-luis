...
Una serie ordenada, de lo básico a lo avanzado (N0 a N4):
...
- [accounting-agent-swarm](https://github.com/jleonceo/accounting-agent-swarm): un enjambre de tres agentes contables de principio a fin, con sus caídas explicadas.
...
An ordered series, from basics to advanced (N0 to N4):
...
- [llm-eval-contable](https://github.com/jleonceo/llm-eval-contable): evaluating a skill the way you examine a student, 66% to 100% measured.
- [accounting-agent-swarm](https://github.com/jleonceo/accounting-agent-swarm): a three-agent accounting swarm end to end, with its drops explained.
